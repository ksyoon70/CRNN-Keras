...
import time 
from Model_v2 import get_Model, CTCLayer
...
batch_size = 32
EPOCHS =  100
MODEL_PATH = 'LSTM_epoch_20220901-161803_val_loss_0.5108.h5'
WEIGHT_PATH = os.path.join(ROOT_DIR,'trained','LSTM_crnn_20220901-160742_weights_epoch_069_val_loss_0.498.h5')
